      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: C.outlineVar.withValues(alpha: 0.3)),
          ),
          child: Text(
            label,
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: isBot
                        ? Border.all(color: C.outlineVar.withValues(alpha: 0.2))
                        : null,
                  ),
                  child: Text(
                    msg.text,
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: C.outlineVar.withValues(alpha: 0.2)),
            ),
            child: const Row(
    ...
    return AnimatedBuilder(
      ...
      builder: (_, __) => Container(
        ...
        decoration: BoxDecoration(
          ...
          color: C.primary.withValues(alpha: 0.3 + _ctrl.value * 0.7),
        ),
      ),
    );
  }
