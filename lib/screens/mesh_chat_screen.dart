...
class _MeshChatScreenState extends State<MeshChatScreen> {
  ...
  late BleMeshNode _meshNode;
  final String _myNickname = 'ECHO_User_${Uuid().v4().substring(0, 4)}';
  ...
  void initState() {
    ...
    _meshNode.incomingPackets.listen((packet) {
      ...
      body: Column(
        children: [
          Container(
            ...
            child: const Row(
              children: [
                Icon(Icons.bluetooth_connected, color: C.primary, size: 16),
                SizedBox(width: 8),
                    ...
                    return Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              isMe ? C.primary.withOpacity(0.2) : C.surfaceLow,
